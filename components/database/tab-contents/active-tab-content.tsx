...
export function ActiveTabContent({
  ...
  const activeCount = databases.filter(db => db.status === "running" || db.status === "starting").length
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <TabHeader
          ...
          description="Databases that are currently running or starting up"
          count={activeCount}
        ...
        <DatabaseGrid
          ...
          filterFn={(db) => db.status === "running" || db.status === "starting"}
